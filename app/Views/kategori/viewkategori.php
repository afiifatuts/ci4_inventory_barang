...
<div class="input-group mb-3">
  <input type="text" name="cari" value="<?= $cari;?>" class="form-control" placeholder="Cari data kategori" aria-label="Recipient's username" aria-describedby="basic-addon2">
...
<table class="table table-striped table-bordered" style="width: 100%;">
    ...
    <tbody>
        ...
        <tr>
            ...
            <form method="POST" action="<?echo site_url('/kategori/hapus/'.$row['katid']); ?>" style="display:inline;" onsubmit="hapus()">
...
<script>
    function edit(id) { 
        window.location=(site_url('/kategori/formedit/'+id));
 }
 function hapus() { 
